...
class PerguntasForm(forms.Form):
    ...
    q4 = forms.ChoiceField(choices=(('a', 'Masculino'), ('b', 'Feminino'), ('c', 'Não tenho preferência.'), ('d', 'Dupla masculina/feminina'), ('e', 'Outro (especifique)')), widget=forms.RadioSelect)
    ...
    q7 = forms.ChoiceField(choices=(('a', 'Christopher Nolan'), ('b', 'Quentin Tarantino'), ('c', 'Martin Scorsese'), ('d', 'Greta Gerwig'), ('e', 'Outro (especifique)')), widget=forms.RadioSelect)

    q8 = forms.ChoiceField(choices=(('a', 'Sim, adoro!'), ('b', 'Sim, gosto.'), ('c', 'Não me importo.'), ('d', 'Não muito.'), ('e', 'Não suporto.')), widget=forms.RadioSelect)

    q9 = forms.ChoiceField(choices=(('a', 'Tom Hanks'), ('b', 'Meryl Streep'), ('c', 'Leonardo DiCaprio'), ('d', 'Scarlett Johansson'), ('e', 'Outro (especifique)')), widget=forms.RadioSelect)
